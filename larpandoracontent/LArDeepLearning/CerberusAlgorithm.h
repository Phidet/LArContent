 ...
 */
	...
	private:
		...
		pandora::StatusCode Backtracing(const torch::Tensor &tensor, pandora::CaloHitList &caloHitListChange, const float minX, const float minZ, const pandora::HitType tpcView, const pandora::CartesianVector ShowerVertex2D);
		...
		pandora::StatusCode CaloHitReallocation(const torch::Tensor &tensor, const pandora::CaloHitList &caloHitListChange, const float minX, const float minZ, const pandora::HitType tpcView, const pandora::CartesianVector ShowerVertex2D);
